...
namespace Nurbsy.Algorithm
{
    ...
    {
        private static void Bitrv2(int n, Span<double> a)
        {
            int j,
                j1,
                k,
        ...
        private static void Cdft(int n, double wr, double wi, Span<double> a)
        {
            int i,
                j,
                k,
        ...
        private static void Rdft(int n, double wr, double wi, Span<double> a)
        {
            int j,
                k;
            double wkr,
        ...
        private static void Ddct(int n, double wr, double wi, Span<double> a)
        {
            int j,
                k,
                m;
        ...
        private static void Ddst(int n, double wr, double wi, Span<double> a)
        {
            int j,
                k,
                m;
        ...
        private static void Bitrv(int n, Span<double> a)
        {
            int j,
                k,
                l,
        ...
        public static void Dfct(int n, double wr, double wi, Span<double> a)
        {
            int j,
                k,
                m,
        ...
        public static void Dfst(int n, double wr, double wi, Span<double> a)
        {
            int j,
                k,
                m,
